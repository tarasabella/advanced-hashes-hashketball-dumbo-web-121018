...
#how can i get there?
#scroll down hash to look for player name and points scored
#iterate with each to access the point values 
#goal= find a player and return w/points 
#how do you find a player: Go through differnt layers to access the player data 
#FIND: jeff adrien and return his points 
#game_hash[:away][:players][0][:points]
#HOW?:
# we had to look through home and away to find which team jeff was on 
# see that hes on away team 
# return his points 


# start at the top levels to access the lower levels values 
#iterate with each method to access data 
#
game_hash.each do |location, team_info|
  team_info[:players].each do |player, player_stats|
    #what am i looping over? =players 
    #what is singular version of it? = player 
    if player[:name] == player_name
      #checks to see that the player equals the name that was put into the method 
